...
$searchVal = isset($_GET['query']) ? $_GET['query'] : '';
$searchVal = filter_var($searchVal, FILTER_SANITIZE_STRING);
...
<?php else: 
    ...
    foreach ($superheroes as $hero) {
        if (strcasecmp($hero['name'], $searchVal) == 0 || strcasecmp($hero['alias'], $searchVal) == 0) {
            $heroFound = true;
